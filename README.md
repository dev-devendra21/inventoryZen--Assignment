# InventoryZen – Internship Assignment
...
- **index.css**: Stylesheet for styling the HTML elements and ensuring responsiveness.
- **index.js**: JavaScript file to add interactivity to the web page.
...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/dev-devendra21/inventoryZen--Assignment.git
   ```

2. **Navigate to the project directory**:

   ```bash
   cd inventoryZen--Assignment
   ```
